 ...
 <a href="http://www.scg.com.cn/" target="_blank">进一步了解 &gt;</a></div>-->
     ...
     <a target="_blank" href="#" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;font-size:12px;"><img src="/xgwl/img/99.png" style="float:left;"/><p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393;">沪公网安备 31010402005450号</p ></a >
   <!--<div style="width:300px;margin:0 auto; padding:20px 0;"></div>--></div></div>
          ...
          <li id="gotop" href="javascript:void(0)" class="pico pico-rbar4 b_h" style="background:#fff;"><img src="xgwl/img/top.png"></li>
</ul>
           <!--移动端悬浮客服-->
