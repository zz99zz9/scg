...
<%dim cid
	  ...
	  sqlnew="select * from [prod] where classid=25"
	  	if bid<>0 then
...
<div class="ubar">
<div class="container">
<a href="#" class="fc-red">SCG</a> <em class="more-arr">&gt;</em> <a href="services.asp">服务咨询</a> <em class="more-arr">&gt;</em> <a href="services6.asp">政策消息</a>
<ul class="menu"><a href="services1.asp">尚鉴尊享会</a><a href="services6.asp">购置流程</a><a href="services3.asp">财税问答</a><a href="services4.asp">贷款咨询</a><a href="services5.asp">移民知识</a><a href="services2.asp" class="on">政策消息</a></ul>
</div>
</div>
<!--公司介绍1-->
<div class="part1">
<div class="container">
    <!--<div style="height:500px;line-height:200px;text-align:center;">暂无内容……稍后更新</div>-->
