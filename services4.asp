...
<%dim cid
	  ...
	  sqlnew="select * from [prod] where classid=11"
	  	if bid<>0 then
...
<div class="ubar">
<div class="container">
<a href="#" class="fc-red">SCG</a> <em class="more-arr">&gt;</em> <a href="services.asp">服务咨询</a> <em class="more-arr">&gt;</em> <a href="services4.asp">贷款咨询</a>
<ul class="menu"><a href="services1.asp">尚鉴尊享会</a><a href="services6.asp">购置流程</a><a href="services3.asp">财税问答</a><a href="services4.asp" class="on">贷款咨询</a><a href="services5.asp">移民知识</a><a href="services2.asp">政策消息</a></ul>
</div>
</div>
<!--公司介绍1-->
<div class="part1">
<div class="container">
    <ul class="list-news2 row ">
     <%
       ...
       %>
        <!---->
        <li><div class="pic col-md-4"><a href="servicesview.asp?id=<%=rsnew("prod_id")%>" class="b_w"><img src="<%=rsnew("prod_pic")%>"></a></div><div class="text col-md-8"><a class="tit fc-red" href="servicesview.asp?id=<%=rsnew("prod_id")%>"><%=rsnew("prod_name")%></a><p class="txt"><%=left(RemoveHTML(rsnew("prod_detail")),200)%>...</p>
