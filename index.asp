...
<!-- 	<a href="services2.asp" class=" wow fadeInUp"><span class="pic"><img src="xgwl/img/index/s1.jpg"><em class="tra bgmask"><b class="xgbtn"><span>查看详情</span><em class="more-arr tra">&gt;</em></b></em></span><p> <i class="arrow-up tra"></i><span class="serline"></span><span class="cname">购置流程</span><span class="ename">Purchase process</span></p></a>-->
 	<a href="services3.asp" class=" wow fadeInUp"><span class="pic"><img src="xgwl/img/index/s2.jpg"><em class="tra bgmask"><b class="xgbtn"><span>查看详情</span><em class="more-arr tra">&gt;</em></b></em></span><p> <i class="arrow-up tra"></i><span class="serline"></span><span class="cname">财税问答</span><span class="ename">Finance & Tax</span></p></a>
 	...
 	<a href="javascript:feedback()" class=" wow fadeInUp" ><span class="pic"><img src="xgwl/img/index/s5.jpg"><em class="tra bgmask"><b class="xgbtn"><span>查看详情</span><em class="more-arr tra">&gt;</em></b></em></span><p> <i class="arrow-up tra"></i><span class="serline"></span><span class="cname">在线提问</span><span class="ename">Online Service</span></p></a>
</ul>
